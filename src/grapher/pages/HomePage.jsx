			...
			<div className={s.footer}>
				...
				<div className={s.footerInfo}>
					<div className={s.footerColumnRight}>
						<p> © Luis Enrique Nava Garcia - 2025 <a href="https://github.com/LuisNavaFisBio/GraPhEr" target="blank_"/> </p> 
					</div>
					<div className={s.footerColumnRight}>
						<img src="../../../assets/icons/github-mark.svg" className={s.footerImage} />
					</div>
				</div>
			</div>
